...
using SmartKylinApp.View.SMSConfigs;

namespace SmartKylinApp.View
{
    public partial class SMSConfig : DevExpress.XtraEditors.XtraUserControl
    {
        public SMSConfig()
        {
            InitializeComponent();
        ...
        {
            var control = new TemplateConfig();
            configPanel.Controls.Clear();
            configPanel.Controls.Add(control);
            control.Dock = DockStyle.Fill;
        }
        ...
        {
            var control = new SmsRecordSearch();
            configPanel.Controls.Clear();
            configPanel.Controls.Add(control);
            control.Dock = DockStyle.Fill;
        }
