...
{
    public partial class AlertQuery : DevExpress.XtraEditors.XtraUserControl
    {
        private string hytype;
        private string bmid;
        private string codewhere;
        private List<Smart_Kylin_Alert> list;
        ...
        private void AlertQuery_Load(object sender, EventArgs e)
        {
            BindTree();
        ...
        private void BindAgreementTree(string mstype)
        {
            ...
            {
                XtraMessageBox.Show("获取监测项描述数据出错");
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                codewhere = bmid + type.Substring(6, 4);
                list = GlobalHandler.alertResp.Find(a => a.CONFIG_CODE.Contains(bmid)).Where(a => a.CONFIG_CODE.Contains(type.Substring(6, 4)))
                .Where(a => a.SAVE_DATE > DateTime.Parse(date_ksrq.Text))
                .Where(a => a.SAVE_DATE < DateTime.Parse(date_jsrq.Text + " 23:59:59"))
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                for (var i = 0; i < list.Count; i++)
                {
                    ...
                    row.CreateCell(4).SetCellValue(list[i].LEVEL);
                    row.CreateCell(5).SetCellValue(list[i].SAVE_DATE.ToString());
                }
